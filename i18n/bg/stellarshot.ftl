...
wizard-append-only-description = Защита срещу грешки, не срещу атаки: самата rustic отказва да изтрие моментно състояние от хранилище само за добавяне, но инструмент, който не е длъжен да го спазва, все пак би могъл да премахне такова направо. Не може да се изключи по-късно: „Освобождаване на място“ и настройката „Запазване“ по-горе спират да работят, щом това е включено. Изберете внимателно; от този екран няма връщане назад.
