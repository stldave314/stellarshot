...
no-repository-suggestion = För att skapa en lagringsplats använd menyn.
no-snapshots = Inga ögonblicksbilder hittades.
...
## Fil
file = Fil
new-repo = Ny lagringsplats
new-snap = Skapa ögonblicksbild
