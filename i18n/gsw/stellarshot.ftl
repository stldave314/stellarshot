...
wizard-append-only-description = En Schutz gäge Fähler, nöd gäge Aagriff: rustic selber weigeret sich, e Momentuufnahm us emne Nur-aahänke-Repository z lösche, aber es Werkzüg, wo sich nöd draa halte muess, chönt eini troztdem direkt entferne. Chan schpöter nüme abgschtellt wärde: „Platz freimache“ und d „Bhalte“-Iistellig obe hörid uf z funktioniere, sobald das aa isch. Wähl sorgfältig; vo däm Bildschirm us gits kes Zrugg.
