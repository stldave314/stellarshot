...
browse-size-reduced = { $size } от { $total }
...
place-signing-in-title = Вписване с Google
place-signing-in-body = Stellarshot отвори браузъра ви по подразбиране, за да завършите вписването. Превключете към него, за да продължите, след което се върнете тук.
...
download = Изтегляне…
restore-mount = Монтиране като папка…
...
select-mount-folder = Изберете празна папка за монтиране
mount-active = Монтирано в { $folder }
mount-open-folder = Отваряне на папката
unmount = Демонтиране
mount-failed = Това копие не можа да бъде монтирано като папка.
...
schedule-on-connect = Архивира автоматично при свързване на устройството
frequency-hourly = Всеки час
frequency-daily = Всеки ден
frequency-weekly = Всяка седмица
frequency-on-connect = При свързване на устройството
...
wizard-compression = Компресия
wizard-compression-description = Колко силно да се компресира всяко архивиране: по-бавно и по-малко, или по-бързо и по-голямо. Задава се само при създаване на архивиране; собствените инструменти на rustic все още могат да го променят по-късно.
wizard-compression-default = По подразбиране
wizard-compression-fast = Бързо
wizard-compression-best = Най-добро
...
wizard-conditions = Условия
wizard-require-ac = Само на захранване от мрежата
wizard-require-ac-description = Пропускане на планирано архивиране, докато се работи на батерия. Пропуснат по този начин интервал остава тих; следващият опитва отново.
wizard-min-battery = Минимално ниво на батерията
wizard-battery-none = Без минимум
wizard-battery-percent = { $percent }%
wizard-block-metered = Не и при лимитирана връзка
wizard-block-metered-description = Пропускане, докато системата е отбелязала текущата връзка като лимитирана, например мобилна точка за достъп на телефон.
