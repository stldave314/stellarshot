...
browse-size-reduced = { $size } av { $total }
...
place-signing-in-title = Logga in med Google
place-signing-in-body = Stellarshot öppnade din standardwebbläsare för att slutföra inloggningen. Växla till den för att fortsätta, och kom sedan tillbaka hit.
...
schedule-on-connect = Säkerhetskopierar automatiskt när enheten ansluts
frequency-hourly = Varje timme
frequency-daily = Varje dag
frequency-weekly = Varje vecka
frequency-on-connect = När enheten ansluts
...
wizard-compression = Komprimering
wizard-compression-description = Hur hårt varje säkerhetskopiering ska komprimeras: långsammare och mindre, eller snabbare och större. Ställs bara in när en säkerhetskopiering skapas; rustics egna verktyg kan fortfarande ändra det senare.
wizard-compression-default = Standard
wizard-compression-fast = Snabb
wizard-compression-best = Bäst
...
wizard-conditions = Villkor
wizard-require-ac = Endast på nätström
wizard-require-ac-description = Hoppa över en schemalagd säkerhetskopiering medan den körs på batteri. Ett tillfälle som hoppas över så förblir tyst; nästa försöker igen.
wizard-min-battery = Lägsta batterinivå
wizard-battery-none = Ingen lägstanivå
wizard-battery-percent = { $percent } %
wizard-block-metered = Inte på en mätbaserad anslutning
wizard-block-metered-description = Hoppa över medan systemet har markerat den aktuella anslutningen som mätbaserad, till exempel en telefons mobila surfzon.
