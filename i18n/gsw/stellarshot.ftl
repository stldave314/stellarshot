...
browse-size-reduced = { $size } vo { $total }
...
place-signing-in-title = Mit Google aamälde
place-signing-in-body = Sterneschuss hät dis Standard-Browser-Fänschter uftue, zum d Aamäldig fertig mache. Wächsle dert häre zum wiitermache, und chumm de wieder hierhär zrugg.
...
schedule-on-connect = Sicheret automatisch, sobald s Lafwärk aagschlosse wird
frequency-hourly = Jedi Stund
frequency-daily = Jede Tag
frequency-weekly = Jedi Wuche
frequency-on-connect = Sobald s Lafwärk aagschlosse wird
...
wizard-compression-description = Wie fescht jedi Sicherig komprimiert wird: langsamer und chliiner, oder schneller und grösser. Wird nur bim Erstelle vomene Sicherig gsetzt; rustic sini eigete Werchzüg chönd's spöter no ändere.
wizard-compression-default = Standard
wizard-compression-fast = Schnäll
wizard-compression-best = Bescht
...
wizard-conditions = Bedingige
wizard-require-ac = Nur am Netzstrom
wizard-require-ac-description = E planti Sicherig überspringe, solangs am Akku lauft. En so usglaa Termin blibt still; de nächscht probierts wieder.
wizard-min-battery = Mindeschte Akkustand
wizard-battery-none = Kes Minimum
wizard-battery-percent = { $percent } %
wizard-block-metered = Nid bi taktierte Verbindig
wizard-block-metered-description = Überspringe, solangs System die aktuelli Verbindig als taktiert markiert hät, zum Bispil de mobil Hotspot vomene Handy.
