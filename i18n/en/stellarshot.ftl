...
browse-size-reduced = { $size } of { $total }
...
place-signing-in-title = Sign In With Google
place-signing-in-body = Stellarshot opened your default browser to finish signing in. Switch to it to continue, then come back here.
...
schedule-on-connect = Backs up automatically when its drive is connected
frequency-hourly = Every hour
frequency-daily = Every day
frequency-weekly = Every week
frequency-on-connect = When its drive is connected
...
wizard-compression-description = How hard to compress each backup: slower and smaller, or faster and larger. Only set when a backup is created; rustic's own tools can still change it later.
wizard-compression-default = Default
wizard-compression-fast = Fast
wizard-compression-best = Best
...
wizard-conditions = Conditions
wizard-require-ac = Only on mains power
wizard-require-ac-description = Skip a scheduled backup while running on battery. A slot missed this way is skipped quietly; the next one tries again.
wizard-min-battery = Minimum battery level
wizard-battery-none = No minimum
wizard-battery-percent = { $percent }%
wizard-block-metered = Not on a metered connection
wizard-block-metered-description = Skip while the system has marked the current connection metered, such as a phone's mobile hotspot.
