...
wizard-append-only-description = Ein Schutz gegen Fehler, nicht gegen Angriffe: rustic selbst weigert sich, eine Momentaufnahme aus einem Nur-anhängen-Repository zu löschen, aber ein Werkzeug, das sich nicht daran halten muss, könnte eine trotzdem direkt entfernen. Kann später nicht mehr ausgeschaltet werden: „Platz freigeben“ und die „Behalten“-Einstellung oben funktionieren nicht mehr, sobald dies an ist. Wähle sorgfältig; von diesem Bildschirm aus gibt es kein Zurück.
